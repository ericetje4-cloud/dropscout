...
et garde vos credentials hors du bundle de l'app.

## Pourquoi un proxy ?

Les API Shopify Admin et WooCommerce REST n'envoient pas les en-têtes CORS
nécessaires aux appels navigateur. De plus, exposer vos tokens d'Admin dans une
PWA statique serait une faille de sécurité. Ce petit Worker résout les deux.
